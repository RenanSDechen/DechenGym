        ...
        "input_schema": {
            ...
            "properties": {"nome": {
                ...
                "enum": ["abdutor_201", "estacao_202", "agachamento_203",
                         ...
                         "banco_reto_211", "banco_dorsal_212",
                         "supino_inclinado_213",
                         "supino_inclinado_reforcado_214", "supino_reto_215",
                         "suporte_anilhas_simples_216", "suporte_anilhas_217",
                         "suporte_halteres_218", "suporte_10_barras_219",
                         "supino_vertical_220", "kit_body_pump_221",
                         "banco_desenvolvimento_222", "abdominal_vertical_059",
                         "academy_house_078"],
            }},
            "required": ["nome"],
        },
